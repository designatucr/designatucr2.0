      ...
      <div class="contact-us">
        ...
        <div class="social-links">
          <div class="social-link">
            <a href="https://www.instagram.com/designatucr/" target="_blank" rel="noopener noreferrer">
              <FontAwesomeIcon icon={faInstagram}  className="icon"/>
            </a>
          </div>
          <div class="social-link">
            <a href="https://www.facebook.com/designatucr/" target="_blank" rel="noopener noreferrer">
        ...
        <div class="social-links">
          <div class="social-link">
             <a href="https://www.linkedin.com/designatucr/" target="_blank" rel="noopener noreferrer">
              <FontAwesomeIcon icon={faLinkedinIn} className="icon"/>
            </a>
          </div>
          <div class="social-link">
              <a href="mailto:designatucr@gmail.com" target="_blank" rel="noopener noreferrer">
        ...
        <div class="social-links">
          <div class="social-link">
            <a href="https://open.spotify.com/user/wnei0wjizwwua4h8fkg8627td?si=ee6daa1d90ef4fb0&nd=1" target="_blank" rel="noopener noreferrer">
                  <FontAwesomeIcon icon={faSpotify} className="icon"/>
              </a>
          </div>
          <div class="social-link">
            <a href="/https://calendar.google.com/calendar/u/0/r?cid=ZGVzaWduYXR1Y3JAZ21haWwuY29t&pli=1" target="_blank" rel="noopener noreferrer">

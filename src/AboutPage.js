    ...
    <div>
      ...
      <div class="landing">
        <div class="landing-text">
          <div class="content">
            <img src="WhiteLong.png" alt="Your Image"></img>
            <p class="landing-text-1"> We are UC Riverside’s first and only design club supporting students in design thinking.</p>
            <p class="landing-text-1">Our mission is to provide students a community to learn more about design. Design@UCR hosts workshops, events, and connects you with career growth oportunities.</p>
          </div>
      ...
      <div class="values">
        ...
        <div class="each-value">
          <div class="value">
            ...
            <p class="value-text">We aim to be a dedicated learning space for students from all backgrounds to learn introductory design.</p>
          </div>
          <div class="value">
            <img src="creativity.png" alt="Value 2"/>
            <p class="value-name">Creativity</p>
            <p class="value-text">We aim to be a home for aspiring designers to enhance their design skills and discover new ways to create.</p>
          </div>
          <div class="value">
            <img src="career.png" alt="Value 3"/>
            <p class="value-name">Career</p>
            <p class="value-text">We aim to provide students an opportunity to network and the necessary resources for a future design career.</p>
          </div>
        </div>
      </div>
